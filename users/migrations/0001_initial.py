    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.URLField(default='https://dn-joway.qbox.me/1465087838481_user_116px_1196112_easyicon.net.png', max_length=255, verbose_name='头像')),
                ('create_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('alink_verify_code', models.CharField(blank=True, max_length=32, null=True, verbose_name='激活链接验证码')),
                ('last_alink_verify_time', models.DateTimeField(blank=True, null=True, verbose_name='上一次激活链接发送请求验证码请求时间')),
                ('role', models.IntegerField(choices=[(0, '管理员'), (1, '普通用户'), (2, '访客')], default=2, verbose_name='角色')),
